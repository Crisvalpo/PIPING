            ...
            {mobileMenuOpen && (
                <div className="md:hidden border-t border-gray-200 bg-white">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        {/* Settings Menu Items - Hidden for USUARIO role */}
                        {userRole !== 'USUARIO' && (
                            <>
                                ...
                                <button
                                    onClick={(e) => {
                                        handleCuadrillasClick(e)
                                        setMobileMenuOpen(false)
                                    }}
                                    className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-base font-medium text-gray-700 hover:bg-gray-100"
                                >
