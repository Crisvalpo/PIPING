...
import WeldConfigModal from '@/components/admin/WeldConfigModal'
...
function AdminProyectoContent() {
    ...
    const [showWeldConfigModal, setShowWeldConfigModal] = useState(false)
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 p-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    {/* Ubicaciones */}
                    <Link href="/admin/proyecto/ubicaciones" className="block h-full">
                        <div className="backdrop-blur-xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-2xl shadow-xl border border-white/20 p-8 hover:scale-105 transition-all duration-200 cursor-pointer h-full flex flex-col justify-between">
                            <div className="flex items-center space-x-4">
                                <div className="p-4 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl shrink-0">
                                    <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-white mb-1">Ubicaciones</h3>
                                    <p className="text-purple-200">Gestiona maestranzas, bodegas y zonas de terreno</p>
                                </div>
                            </div>
                        </div>
                    </Link>
                    ...
                    {/* Configuración de Uniones */}
                    <div
                        onClick={() => setShowWeldConfigModal(true)}
                        className="backdrop-blur-xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl shadow-xl border border-white/20 p-8 hover:scale-105 transition-all duration-200 cursor-pointer h-full flex flex-col justify-between"
                    >
                        <div className="flex items-center space-x-4">
                            <div className="p-4 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-xl shrink-0">
                                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white mb-1">Tipos de Unión</h3>
                                <p className="text-purple-200">Define soldaduras y roscadas personalizadas</p>
                            </div>
                        </div>
                    </div>
                    {/* Gestión de Roles */}
                ...
                {proyecto && (
                    <WeldConfigModal
                        isOpen={showWeldConfigModal}
                        onClose={() => setShowWeldConfigModal(false)}
                        proyectoId={proyecto.id!}
                    />
                )}
            </div>
